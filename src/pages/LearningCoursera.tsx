...
const LearningCoursera: React.FC = () => {
  ...
  return (
    <>
      <PageHeader
        title="Learning Resources: Coursera"
        subtitle="Explore courses and specializations from top universities and companies." // Updated subtitle
      />
      <div className="container max-w-7xl mx-auto px-4 py-12">
        ...
        {!isLoading && initialAccessAllowed && (
          <>
            {/* Placeholder content */}
            <p>Coursera learning resources content goes here.</p>
            {/* Add more specific content for Coursera later */}
          </>
        )}
