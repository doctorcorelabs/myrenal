...
const LearningUpToDate: React.FC = () => {
  ...
  return (
    <>
      <PageHeader
        title="Learning Resources: UpToDate"
        subtitle="Evidence-based clinical decision support resource." // Updated subtitle
      />
      <div className="container max-w-7xl mx-auto px-4 py-12">
        ...
        {!isLoading && initialAccessAllowed && (
          <>
            {/* Placeholder content */}
            <p>UpToDate learning resources content goes here.</p>
            {/* Add more specific content for UpToDate later */}
          </>
        )}
